...
public class ViewAndRentVehicles_Function {
    ...
    public ViewAndRentVehicles_Function() {
        loadSampleVehicles(); // Load sample vehicles when the function is initialized
    }
...
public static void viewAndRentVehicles() {
    ...
    if (confirm.equals("Y")) {
        ...
        VehicleRentalSystem.rentalHistory.add(new RentalRecord(selectedVehicle, startDate, rentalDays));
